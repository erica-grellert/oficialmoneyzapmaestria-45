...
serve(async (req) => {
  ...
  try {
    ...
    // Get Stripe secret key from moneyzap_settings
    console.log("Fetching Stripe configuration from moneyzap_settings...");
    ...
    if (!subscription?.stripe_customer_id) {
      ...
      throw new Error(
        "No active subscription found. Please subscribe to a plan to manage your subscription."
      );
    }
    ...
    const origin =
      req.headers.get("origin") || "https://poupeja-demonstracao.vercel.app";
