  ...
  const getStatus = () => {
    if (progress >= 100)
      return {
        label: "Concluída",
        color: "success",
        bgColor: "bg-mz-gold-50",
        textColor: "text-mz-gold-700",
      };
    ...
    >
      ...
      <div className="mb-4">
        <div className="flex items-baseline gap-2 mb-2">
          <span className="text-2xl font-bold text-mz-gold-600 font-mono">
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="flex items-end gap-0.5 h-6">
            {sparklineData.map((value, index) => (
              <div
                key={index}
                className="w-1 bg-mz-gold-400 rounded-sm"
      ...
      <div className="flex gap-2">
        ...
        {progress >= 100 && status.label !== "Concluída" && onComplete && (
          <Button
            ...
            size="sm"
            className="flex-1 bg-mz-gold-600 hover:bg-mz-gold-700"
          >
