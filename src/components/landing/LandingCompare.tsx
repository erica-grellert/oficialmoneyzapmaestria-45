...
const LandingCompare = () => {
  ...
  return (
    <section id="f5-compare" className="py-16 md:py-20 bg-white w-full">
      <div className="container max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            ...
            <div className="font-semibold text-lg text-gray-900 p-4 text-center bg-primary/5 rounded-lg">
              MoneyZap
            </div>
          </div>
          ...
          {compareItems.map((item, index) => (
            <motion.div
              key={index}
              className={`grid grid-cols-3 gap-4 py-4 border-b border-gray-200 ${
