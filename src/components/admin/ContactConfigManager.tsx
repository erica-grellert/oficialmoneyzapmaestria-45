    ...
    try {
      ...
      if (data?.success && data?.settings) {
        ...
        setFormData({
          ...
          whatsappMessage:
            contactSettings.whatsapp_message?.value ||
            "Olá! Preciso de ajuda com o Meu Controle IA.",
        });
      }
    } catch (err) {
  ...
  const handleSave = async () => {
    try {
      ...
      toast({
        ...
        description:
          error.message ||
          "Não foi possível salvar as configurações de contato.",
        variant: "destructive",
      });
    } finally {
      setIsUpdating(false);
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <div className="text-green-700 text-sm space-y-2">
                <p>
                  Configure os canais de comunicação disponíveis para os
                  usuários.
                </p>
                <p>
                  Essas informações serão usadas nos botões de contato e
                  redirecionamentos.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Olá! Preciso de ajuda com o Meu Controle IA."
              disabled={isUpdating}
            />
            <p className="text-xs text-gray-500">
          ...
          {formData.contactPhone && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              ...
              <p className="text-blue-700 text-xs font-mono break-all">
                https://wa.me/{formData.contactPhone}?text=
                {encodeURIComponent(formData.whatsappMessage)}
              </p>
            </div>
          )}
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="suporte@meucontroleia.com"
              disabled={isUpdating}
            />
            <p className="text-xs text-gray-500">
