...
import { Save, Loader2, Image, Globe } from "lucide-react";
    ...
    try {
      ...
      if (data?.success && data?.settings) {
        ...
        setFormData({
          ...
          companyDescription: brandingSettings.company_description?.value || "",
    ...
    try {
      ...
      if (error) {
        ...
        if (
          ...
          throw new Error(
            'Bucket de storage não encontrado. Execute o deployment do Supabase para criar o bucket "uploads".'
          );
        }
    ...
    try {
      ...
      if (data?.success) {
        ...
        toast({
          ...
          description:
            "Logo e favicon foram atualizados com sucesso. Atualizando todas as abas...",
        });
      ...
      toast({
        ...
        description:
          error.message ||
          "Não foi possível salvar as configurações de branding.",
        variant: "destructive",
      });
    } finally {
      setIsUpdating(false);
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="faviconFile">
                Upload Novo Favicon (PNG, JPG)
              </Label>
              <Input
                id="faviconFile"
                type="file"
                ...
                onChange={(e) =>
                  handleFileChange(e.target.files?.[0] || null, "favicon")
                }
                disabled={isUpdating}
              />
              {faviconFile && (
