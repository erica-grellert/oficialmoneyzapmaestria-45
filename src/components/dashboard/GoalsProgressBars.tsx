    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {goals.map((goal) => {
          ...
          const { status, color, text, bgColor, textColor } = getGoalStatus(
            goal.currentAmount,
            goal.targetAmount,
            goal.deadline
          );
          ...
          return (
            <div
              key={goal.id}
              className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg hover:scale-[1.01] transition-all duration-200"
            >
              {/* Cabeçalho da meta */}
                ...
                {suggestedContribution > 0 && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-emerald-600">
                      {formatCurrency(suggestedContribution)}/mês
                    </span>
                  </div>
                )}
