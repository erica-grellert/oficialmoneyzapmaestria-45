      ...
      <Table>
        ...
        <TableBody>
          {transactions.map((transaction, index) => {
            ...
            const iconColor =
              transaction.type === "income" ? "#50a077" : "#dd7979";
                      ...
                      <p className="text-sm font-medium text-foreground mb-1">
                        {transaction.description || t("common.noDescription")}
                         ...
                         className={cn(
                           "text-xs",
                           transaction.type === "income"
                             ? "text-[#50a077] border-[#50a077] bg-[#eff7f2] hover:bg-[#eff7f2]/80"
                             : "text-[#dd7979] border-[#dd7979] bg-[#fff1f2] hover:bg-[#fff1f2]/80"
                         )}
                       >
