              ...
              <div className="flex flex-col gap-3 xs:gap-4 sm:gap-6 sm:flex-row sm:items-start sm:justify-between">
                <div className="space-y-2 sm:space-y-3 min-w-0 flex-1">
                  <div className="flex items-center gap-2 xs:gap-3 sm:gap-4">
                    <div className="w-10 h-10 xs:w-12 xs:h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-xl xs:rounded-2xl sm:rounded-3xl bg-emerald-500 flex items-center justify-center shadow-lg flex-shrink-0">
                ...
                <div className="flex items-center gap-2 xs:gap-3 flex-shrink-0">
                  ...
                  <Button
                    ...
                    className="gap-1.5 xs:gap-2 sm:gap-3 h-9 xs:h-10 sm:h-11 lg:h-12 px-3 xs:px-4 sm:px-6 lg:px-8 rounded-lg xs:rounded-xl sm:rounded-2xl bg-emerald-500 hover:bg-emerald-600 shadow-lg hover:shadow-xl transition-all duration-300 font-semibold text-white text-xs xs:text-sm sm:text-base"
                  >
              ...
              <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:gap-8 xl:grid-cols-3 2xl:grid-cols-5">
                ...
                <div className="xl:col-span-1 2xl:col-span-2">
                  <Card className="border border-slate-200 shadow-lg overflow-hidden h-full bg-white">
                    <div className="bg-emerald-50 px-3 xs:px-4 sm:px-6 py-2.5 xs:py-3 sm:py-4 border-b border-emerald-100">
                      <div className="flex items-center gap-1.5 xs:gap-2 sm:gap-3">
                        <div className="w-5 h-5 xs:w-6 xs:h-6 sm:w-8 sm:h-8 rounded-md xs:rounded-lg sm:rounded-xl bg-emerald-500 flex items-center justify-center flex-shrink-0">
                        ...
                        {(statusFilter || searchQuery) && (
                          <div className="px-1.5 xs:px-2 sm:px-3 py-0.5 xs:py-1 sm:py-1.5 bg-emerald-500 text-white rounded-full text-[10px] xs:text-xs sm:text-sm font-semibold flex-shrink-0">
                            Ativos
                          </div>
                        )}
                      </div>
            ...
            {paginatedGoals.length > 0 ? (
              ...
              <div className="text-center py-12 sm:py-16">
                ...
                {!statusFilter && !searchQuery && (
                  <Button
                    onClick={handleAddGoal}
                    className="gap-2 sm:gap-3 h-10 sm:h-12 px-6 sm:px-8 rounded-xl sm:rounded-2xl bg-emerald-500 hover:bg-emerald-600 shadow-lg hover:shadow-xl transition-all duration-300 font-semibold text-white"
                  >
