export default {
  ...
  auth: {
    ...
    forgotPasswordDescription: "Digite seu e-mail para receber instruções de como redefinir sua senha",
    resetPasswordTitle: "Nova Senha",
    resetPasswordDescription: "Crie uma nova senha segura para sua conta",
  ...
  offline: {
    title: "Offline",
    description:
      "Você está atualmente offline. Algumas funcionalidades podem não estar disponíveis.",
  },
  timeRanges: {
    today: "Hoje",
    yesterday: "Ontem",
  ...
  errors: {
    ...
    pageNotFoundDescription:
      "Desculpe, não conseguimos encontrar a página que você procura. Ela pode ter sido movida ou excluída.",
